...
<body>
	...
	<div class="checkout">
		<div class="container">
			<h3>Terima kasih, telah membeli <?php echo $itungtrans3 ?> barang di My Stile</span></h3><br>
	...
	<div class="checkout-left">	
		<div class="checkout-left-basket" style="margin-top:20px;">
		...
		<div class="checkout-left-basket" style="width:100%;margin-top:20px;">
			<div class="checkout-left-basket">
				...
				<h3 style="margin-right: 222px"><input  type="text" value="<?php echo $orderidd ?>" disabled \></h3>
			</div>
		</div>
	...
	<hr>
	<br><center>
		<h2>Bila telah melakukan pembayaran, konfirmasikan pembayaran Anda.</h2>
		<br>
