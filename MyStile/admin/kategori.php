...
if (isset($_GET['hal'])) 
{
  if ($_GET['hal'] == "hapus") 
  {
    $hapus = mysqli_query($conn,"DELETE FROM kategori WHERE idkategori = '$_GET[id]' ");
    if ($hapus) 
    {
      echo "<script>alert('hapus data sukses');document.location='kategori.php';</script>";
    }
  }
}
?>
...
<head>
  ...
  <title>Kelola Kategori - My Stile</title>
                  ...
                  <div class="card-body">
                   ...
                   <div class="data-tables datatable-dark">
                     <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
                       ...
                       <td>
                        <a href="kategori.php?hal=hapus&id=<?php echo $p['idkategori'] ?>" class="btn-danger btn">Hapus</a>
                        <a  data-toggle="modal" data-target="#editmodal<?php echo $p['idkategori']?>" class="btn btn-primary btn-edit">Edit</a>
                      </td>
                    </tr>		

                    <?php 
                    include 'modalkategori.php';
                  }
...
<!-- <script>
  ...
  $("#editmodal").on('show.bs.modal', function(e) {
    var idkategori = $(e.relatedTarget).data('idkategori');
    var namakategori = $(e.relatedTarget).data('namakategori');
