...
if (isset($_GET['hal'])) 
{
    ...
    $hapus = mysqli_query($conn,"DELETE FROM produk WHERE idproduk = '$_GET[id]' ");


    echo "<script>alert('hapus data sukses');document.location='produk.php';</script>";

  }
	// elseif ($_GET['hal'] == "edit") 
	// {
	// 	$tampil =  mysqli_query($conn,"SELECT * FROM produk WHERE idproduk = '$_GET[id]' ");
...
<head>
	...
	<title>Kelola Produk - My Stile</title>
             ...
             <tr>
              ...
              while($p=mysqli_fetch_array($brgs)){
               ...
               <tr>
                ...
                <td>
                 <a href="produk.php?hal=hapus&id=<?php echo $p['idproduk'] ?>" class="btn-danger btn">Hapus</a>

                 <a  data-toggle="modal" data-target="#editmodal<?php echo $p['idproduk']?>"  class="btn btn-primary btn-edit">Edit</a>
               </td>
  ...
  <div class="modal-body">
    <form action="produk.php" method="post" enctype="multipart/form-data" >
     <div class="form-group">
      ...
      <input name="namaproduk" value="" type="text" class="form-control" required autofocus>
    </div>
    <div class="form-group">
...
<!-- <script>
   $("#editmodal").on('show.bs.modal', function(e) {
      ...
      var hafter = $(e.relatedTarget).data('hafter');
      var deskripsi = $(e.relatedTarget).data('deskripsi');
      var hbefore = $(e.relatedTarget).data('hbefore');
